            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" style="margin-bottom: 10px">Delete Session</h4>
                    </div>
               ...
               <div class="modal-dialog">
                   <div class="modal-content">
                       <div class="modal-header">
                           ...
                           <h4 class="modal-title">Create Sessions</h4>
                       </div>
                       <div class="modal-body">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Edit Sessions</h4>
                    </div>
                    <div class="modal-body">
                        @include('sessions.fields')
                    ...
                    <div class="modal-footer">
                         <input type="hidden" id="editDetails" value="{{ url("/sessions") }}">
                        <button type="button" class="btn btn-danger btn-simple" data-dismiss="modal">Cancel</button>
                        <button type="submit" class="btn btn-success btn-simple">Save</button>
                    </div>
                </div>
