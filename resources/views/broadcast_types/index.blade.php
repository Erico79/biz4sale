...
@section('content')
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <h4 class="card-title">Broadcast Types</h4>
                            <div class="toolbar">
                             <div class="row">
                                <div class="col-md-12">
       ...
       {{--delete-modal--}}
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" style="margin-bottom: 10px">Delete Broadcast Types</h4>
                    </div>
                    <div class="modal-body">
                         <p>Are you sure you want to delete this Broadcast Types?</p>
                    </div>
        ...
        <div class="modal fade" id="create-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
           {!! Form::open(['route' => 'broadcastTypes.store']) !!}
               <div class="modal-dialog">
                   <div class="modal-content">
                       <div class="modal-header">
                           ...
                           <h4 class="modal-title">Create Broadcast Types</h4>
                       </div>
                       <div class="modal-body">
                           @include('broadcast_types.fields')
                       </div>
                       <div class="modal-footer">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Edit Broadcast Types</h4>
                    </div>
                    <div class="modal-body">
                        @include('broadcast_types.fields')
                    ...
                    <div class="modal-footer">
                         <input type="hidden" id="editDetails" value="{{ url("/broadcastTypes") }}">
                        <button type="button" class="btn btn-danger btn-simple" data-dismiss="modal">Cancel</button>
                        <button type="submit" class="btn btn-success btn-simple">Save</button>
                    </div>
                </div>
